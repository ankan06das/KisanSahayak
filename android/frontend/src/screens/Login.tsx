...
const Login = () => {
    ...
    const handleRegister = () => {
      axios.post("http://192.168.54.212:3001/auth/register", form)
    ...
    const handleLogin = async () => {
      ...
      const loggedInResponse = await fetch("http://192.168.54.212:3001/auth/login", {
        method: "POST",
      ...
      if (loggedIn.token)
      {
        dispatch(setUserData(loggedIn.user));
        setForm({
          name: '',
          gender: '',
          dob: '',
